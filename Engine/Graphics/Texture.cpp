...
namespace nc
{
	...
	void Texture::Draw(const Vector2& position, float angle,const Vector2& scale, const Vector2& orgin)
	{
	...
	void Texture::Draw(const SDL_Rect& source, const Vector2& position, float angle, const Vector2& scale, const Vector2& orgin)
	{
