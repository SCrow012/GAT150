...
namespace nc
{
	...
	void Texture::Draw(const Vector2& position, float angle,const Vector2& scale, const Vector2& orgin, bool flip)
	{
		Vector2 size = GetSize();
		size = size * scale;

		Vector2 newPosition = position - (size * orgin);
	...
	void Texture::Draw(const SDL_Rect& source, const Vector2& position, float angle, const Vector2& scale, const Vector2& orgin, bool flip)
	{
